...
export default function Header() {
    return (
        <div className='min-h-[80vh] mb-4 bg-cover bg-center flex items-center w-full overflow-hidden relative' style={{backgroundImage: `url(${hero})`}} id="Header">
          ...
          <motion.div
            ...
            <div className="max-w-3xl pt-24 pb-14">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">Afri Kan-excel Foundation</h1>
              <p className="mt-4 text-lg md:text-xl text-white/95">Building resilient communities across Africa through education, entrepreneurship, and sustainable development.</p>
